      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        <div className="animate-slide-up">
          ...
          <p className="text-xl md:text-2xl text-muted-foreground mb-8 max-w-3xl mx-auto leading-relaxed">
            Simulate, Test, and Deploy backend services with ease. 
            Support for <span className="text-primary font-semibold">REST APIs</span>, 
            <span className="text-primary font-semibold"> GraphQL</span>, and 
            <span className="text-primary font-semibold"> WebSockets</span> in one unified platform.
          </p>
          ...
          <div className="flex flex-wrap justify-center gap-4 max-w-2xl mx-auto">
            ...
            <Badge variant="secondary" className="px-4 py-2">WebSocket</Badge>
            <Badge variant="secondary" className="px-4 py-2">Real-time Testing</Badge>
            <Badge variant="secondary" className="px-4 py-2">Mock Data</Badge>
          </div>
        </div>
      </div>
    </section>
