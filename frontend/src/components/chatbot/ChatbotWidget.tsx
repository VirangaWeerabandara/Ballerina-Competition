  ...
  return (
    <>
      ...
      >
        ...
        <div
          className={cn(
            "relative bg-white/95 backdrop-blur-xl shadow-lg transition-all duration-300 ease-out",
            "flex flex-col",
            isMinimized
        ...
        >
          ...
          {isMinimized && (
            <div
              className="w-full h-full rounded-full bg-primary/90 flex items-center justify-center cursor-pointer hover:scale-105 transition-all duration-200 shadow-md"
