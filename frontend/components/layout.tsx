...
import { 
  Menu, X, Search, User, ChevronDown, ChevronRight, Plus,
  Route, Database, Code2, Play, FileText, Settings, 
  Activity, Folders, Store, MessagesSquare, Globe, MousePointer,
  Move, ZoomIn, ZoomOut, RotateCcw, Save, Share2
} from 'lucide-react';
...
const Layout: React.FC<LayoutProps> = ({ children, currentPage = 'projects', projectId }) => {
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-lg font-bold text-gray-900">oneBlok</span>
                  </div>
                </div>

                <div className="text-center">
                  <h1 className="text-lg font-semibold text-gray-900">Main canvas</h1>
                </div>
                ...
                <div className="flex items-center space-x-2">
                  <div className="flex items-center bg-gray-100 rounded-lg p-1">
                    ...
                    <span className="px-2 text-sm font-medium">{canvasZoom}%</span>
                    <button 
